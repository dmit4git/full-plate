...
DNS.6 = containers."$DOMAIN" # portainer subdomain
DNS.7 = data."$DOMAIN" # pgadmin subdomain
DNS.8 = admin."$DOMAIN" # orchard-cms subdomain
DNS.9 = localhost
IP.1 = 192.168.2.30 # internal IP address
IP.2 = 142.250.176.206 # external IP address
