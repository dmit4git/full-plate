...
// import "../../../public/prime-themes/soho-dark/theme.css";
...
export default function Register(props: RegisterProps) {
    ...
    const { messageHeader, url, messagesPerField, recaptchaRequired, recaptchaVisible, recaptchaSiteKey,
        recaptchaAction, termsAcceptanceRequired, realm } = kcContext;
    ...
    return (
        <div className="main-section-wrapper">
            <div className="main-section mx-auto">
                ...
                >
                    <form id="kc-register-form" className={kcClsx("kcFormClass")} action={url.registrationAction}
                          method="post">
                        ...
                        <div className={kcClsx("kcFormGroupClass", "mt-5")}>
                            ...
                            {recaptchaRequired && !recaptchaVisible && recaptchaAction !== undefined ? (
                                ...
                                <div id="kc-form-buttons" className={kcClsx("kcFormButtonsClass")}>
                                    ...
                                    <FormButton type="submit"
                                                label={msgStr("doRegister")} style={{fontSize: "16px"}}
                                                disabled={!isFormSubmittable || (termsAcceptanceRequired && !areTermsAccepted)}
                                    />
                                </div>
                            )}
